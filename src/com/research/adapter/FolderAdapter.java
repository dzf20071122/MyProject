...
import com.research.AlbumActivity;
import com.research.ImageFile;
import com.research.R;
import com.research.ShowAllPhoto;
import com.research.util.BitmapCache;
import com.research.util.BitmapCache.ImageCallback;
...
//			holder.imageView.setImageBitmap( AlbumActivity.contentList.get(position).imageList.get(0).getBitmap());
	...
	private class ImageViewClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			intent.putExtra("data", ImageFile.fCustomerVo);
