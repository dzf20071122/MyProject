...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		defaultTabLayoutParams = new LinearLayout.LayoutParams(100, LayoutParams.MATCH_PARENT);
	...
	public void notifyDataSetChanged() {
		...
		viewArray = new View[tabCount];
		
		iconArray = new int[tabCount];
		iconArray[0] = R.drawable.tab_weixin;
		iconArray[1] = R.drawable.tab_find;
		iconArray[2] = R.drawable.tab_contact_list;
		iconArray[3] = R.drawable.tab_contact_list;
		iconArray[4] = R.drawable.tab_profile;
	...
	private void addTextTab(final int position, String title) {
		...
		View item = inflater.inflate(R.layout.main_bottom_menu, null);
		viewArray[position] = item;
		ImageView icon = (ImageView)item.findViewById(R.id.ib_weixin);
		icon.setImageResource(iconArray[position]);
		
		TextView tab = (TextView)item.findViewById(R.id.tv_weixin);
		tab.setText(title);
		
		TextView msgTipText = (TextView)item.findViewById(R.id.unread_msg_number);
		msgTipText.setVisibility(View.GONE);
//		msgTipText.setText(title);
		/**
...
//		item.setOrientation(LinearLayout.VERTICAL);
		...
		icon.setImageResource(R.drawable.tab_weixin);
		icon.setLayoutParams(new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT, 28));
...
//			View v = ((LinearLayout)tabsContainer.getChildAt(i)).getChildAt(0);
			...
			TextView v = (TextView)((RelativeLayout)tabsContainer.getChildAt(i)).findViewById(R.id.tv_weixin);

			v.setBackgroundResource(tabBackgroundResId);
			
			ImageView icon = (ImageView)((RelativeLayout)tabsContainer.getChildAt(i)).findViewById(R.id.ib_weixin);
...
//		TextView msgTv = (TextView) layout.getChildAt(1);
		...
		TextView msgTv = (TextView) layout.findViewById(R.id.unread_msg_number);
